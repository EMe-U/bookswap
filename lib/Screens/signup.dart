    ...
    try {
      ...
      try {
        ...
        if (errorMessage.contains('too-many-requests')) {
          userMessage =
              'Account created! Verification email was blocked due to too many requests. '
              'Please try again in a few minutes. You can resend it from the email verification screen after logging in.';
        } else {
          userMessage =
              'Account created successfully! However, we couldn\'t send the verification email right now. '
                ...
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [
                      ...
                      Color.fromARGB(255, 7, 7, 42).withOpacity(0.9),
                    ],
