...
class BottomNavigation extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Use SafeArea and a stable bottom navigation height to avoid
    // overlapping device insets (notches / gesture areas) and overflow
    ...
    return SafeArea(
      ...
      child: ClipRRect(
        child: Container(
          ...
          decoration: const BoxDecoration(color: Color.fromARGB(255, 7, 7, 42)),
          child: Row(
...
class _NavItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: Container(
        // Reduce vertical padding so the inner Column fits within the
        // available nav bar height on smaller devices / web where the
        // height can be tighter. Horizontal padding preserved.
        ...
        child: Column(
          ...
          children: [
            ...
            Icon(
              ...
              // Use slightly smaller icons to guarantee fit inside nav
            ...
            Text(
              ...
              style: TextStyle(
                color: isSelected
                    ? Colors.white
                    : const Color.fromARGB(255, 150, 150, 150),
                // Slightly reduce font sizes to avoid overflow
