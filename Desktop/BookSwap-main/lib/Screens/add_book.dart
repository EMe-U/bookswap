...
class _AddBookState extends ConsumerState<AddBook> {
  ...
  Future<void> _submitForm() async {
    ...
    if (!_isEditMode && _coverImage == null && _coverImageBytes == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
    ...
    try {
      ...
      if (_isEditMode && widget.book != null) {
        ...
        await bookService.updateBook(
          ...
          coverImageFile: kIsWeb
              ? _coverImageBytes
              : _coverImage, // Optional - File or bytes
        );
        ...
        await bookService.createBook(
          ...
          author: _authorController.text.trim(),
          condition: _selectedCondition,
          coverImageFile: kIsWeb ? _coverImageBytes : _coverImage!,
        );
